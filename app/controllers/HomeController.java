...
public class HomeController  extends Controller {
    ...
    @Inject
    public HomeController(FormFactory formFactory, ComputerServiceImpl computerService) {
    ...
    public Result edit(Long id) {
        Form<Computer> computerForm = formFactory.form(Computer.class).fill(computerService.getComputerById(id));
        return ok(
    ...
    public Result update(Long id) throws PersistenceException {
        ...
        try {
            Computer savedComputer = computerService.getComputerById(id);
            if (savedComputer != null) {
                ...
                computerService.updateComputer(savedComputer);
